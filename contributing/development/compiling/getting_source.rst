...
The source code is available on `GitHub <https://github.com/redot-engine/redot-engine>`__
...
For any stable release, visit the `release page <https://github.com/redot-engine/redot-engine/releases>`__
...
after the ``--branch`` (or just ``-b``) argument::
    ...
    git clone https://github.com/redot-engine/redot-engine.git -b 4.3

    # Clone the `4.3-stable` tag. This is a fixed revision that will never change.
    git clone https://github.com/redot-engine/redot-engine.git -b 4.3-stable
...
The `maintenance branches <https://github.com/redot-engine/redot-engine/branches/all>`__
...
`redot-engine/redot-engine-builds on GitHub <https://github.com/redot-engine/redot-engine-builds/releases>`__.
